...
const Login = () => {
  return (
    <div className='flex min-h-screen justify-center items-center'>
      <div className=' flex border rounded-2xl shadow-2xl overflow-hidden'>
      ...
      <div className="p-10 w-[350px] flex flex-col items-center ">
        <form className="flex flex-col items-center w-full ">
          ...
          <button className='bg-[#6770f1] text-white font-semibold rounded h-[30px] w-[250px] border mt-5 mb-[20px]'>Log in</button>
        </form>
